 ...
 switch ( mode )
{
 ...
 case 1: {  analogWrite(LED_PIN_R,0);
            analogWrite(LED_PIN_G, 0);
            analogWrite(LED_PIN_B,255); 
            }
            break;
            
 case 2: { analogWrite(LED_PIN_R,0);
            analogWrite(LED_PIN_G, 255);
            analogWrite(LED_PIN_B,255); 
            }break;
            
 case 3: { analogWrite(LED_PIN_R,0);
            analogWrite(LED_PIN_G, 255);
            analogWrite(LED_PIN_B,05); 
            }break;
            
 case 4: { analogWrite(LED_PIN_R,125);
...
{
    //IMPLEMENT
    int mynote=analogRead(NOTE_IN_PIN);
  ...
  // IMPLEMENT
   int mynote=analogRead(NOTE_IN_PIN);
    ...
    if(analogRead(NOTE_IN_PIN) > 8) {
      ...
      {
        tone(BUZZER_PIN, mynote);
        notes[countNotes] = mynote;
        countNotes++; 
      }
      //noTone(BUZZER_PIN);
    }
    //if(countNotes > 16) noTone(BUZZER_PIN);
//    } else {
//       countNotes = 0;
//      }
